...
{
    public static ArrayList<TFAchievement> itemPickupMap = new ArrayList();
    public static ArrayList<TFAchievement> itemCraftingMap = new ArrayList();
    ...
    {
        if (e.entityPlayer != null && e.entityPlayer instanceof EntityPlayer && e.item.getEntityItem() != null)
        {

...
public abstract class TileEntityMJMachine extends TileEntityTofuMachine implements IHasWork, IEnergyHandler
{
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            flag1 = true;
            this.getMachineBlock().updateFurnaceBlockState(this.TofuMachineRunningTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
        }
